...
import { auth, db, fetchMarketplaceProducts, fetchStores, getUserProfile, fetchHubs, createOrdersFromCart, updateOrderPayment, trackPageView, requestRoleUpgrade, logFailedPayment } from './firebase';
